...
export default function WizardContainer() {
  ...
  return (
    <div id="wizard-root" className="min-h-screen w-full font-body bg-wood-grain">
      ...
      <div className="shadow-inner border border-yellow-400 rounded-xl p-4 sm:p-6 md:p-8 mb-6 panel-parchment">
      ...
      <div className="rounded-xl shadow p-4 sm:p-6 md:p-8 prose prose-lg prose-indigo panel-parchment">
        <StepComponent />
      </div>
